...
<head>
 ...
 <link href="{{asset('public/admin_asset/assets/bootstrap/css/bootstrap-fileupload.css')}}" rel="stylesheet" />
   ...
   <div class="navbar-inner">
     <div class="container-fluid">
       ...
       <a class="brand" href="index.html">
         <img src="{{asset('public/admin_asset/img/logo.png')}}" alt="Metro Lab" />
       </a>
       <!-- END LOGO -->
         ...
         <ul class="nav top-menu">
           ...
           <li class="dropdown" id="header_inbox_bar">
             ...
             <ul class="dropdown-menu extended inbox">
               ...
               <li>
                 <a href="#">
                   <span class="photo"><img src="{{asset('public/admin_asset/img/avatar-mini.png')}}" alt="avatar" /></span>
                   <span class="subject">
     ...
     <div class="top-nav ">
       <ul class="nav pull-right top-menu" >
         ...
         <li class="dropdown">
           <a href="#" class="dropdown-toggle" data-toggle="dropdown">
             <img src="{{asset('public/admin_asset/img/avatar1_small.jpg')}}" alt="">
             <span class="username">Taznin Nahar</span>
             <b class="caret"></b>
           </a>
...
<div id="container" class="row-fluid">
  ...
  <div class="sidebar-scroll">
   ...
   <ul class="sidebar-menu">
    ...
    <li class="sub-menu">
      <a href="{{URL::to('/manage-category')}}" class="">
        <i class="icon-cogs"></i>
    ...
    <li class="sub-menu">
      <a href="{{URL::to('/manage-brand')}}" class="">
        <i class="icon-cogs"></i>
    ...
    <li class="sub-menu">
      <a href="{{URL::to('/add-product')}}" class="">
        <i class="icon-tasks"></i>
    ...
    <li class="sub-menu">
      <a href="{{URL::to('/manage-product')}}" class="">
        <i class="icon-th"></i>
...
<script type="text/javascript" src="{{asset('public/admin_asset/assets/jquery-slimscroll/jquery-ui-1.9.2.custom.min.js')}}"></script>
<script type="text/javascript" src="{{asset('public/admin_asset/assets/jquery-slimscroll/jquery.slimscroll.min.js')}}"></script>
<script src="{{asset('public/admin_asset/assets/fullcalendar/fullcalendar/fullcalendar.min.js')}}"></script>
<script src="{{asset('public/admin_asset/assets/bootstrap/js/bootstrap.min.js')}}"></script>
...
<!-- ie8 fixes -->
   ...
   <script src="{{asset('public/admin_asset/assets/jquery-easy-pie-chart/jquery.easy-pie-chart.js')}}" type="text/javascript"></script>
